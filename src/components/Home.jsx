    ...
    >
      ...
      <div className="max-w-7xl mx-auto text-center relative z-10">
        ...
        <div className="mt-20 max-w-7xl mx-auto px-6">
          ...
          >
            Your Journey to <span className="text-[#3291B6]">Studying Abroad</span>  Starts Here
          </motion.h2>
            ...
            <div className="space-y-10 order-1 lg:order-2">
              ...
              >
                <div className="flex items-start gap-6">
                  <div className="w-16 h-16  rounded-2xl flex items-center justify-center bg-[#3291B6] shadow-lg flex-shrink-0">
                    <span className="text-3xl text-[#F1E2E2]">
                      <CiSearch />
                    </span>
                  </div>
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Find programs by country, degree level, tuition budget,
                      GPA & IELTS requirements — instantly filtered to match
                      your profile.
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-start gap-6">
                  <div className="w-16 h-16 b rounded-2xl flex items-center justify-center bg-[#3291B6] shadow-lg flex-shrink-0">
                    <span className="text-3xl text-[#F1E2E2]">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Compare up to 3 universities at once — tuition, rankings,
                      eligibility, duration, and more — to make the best
                      decision.
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Check eligibility instantly and apply directly through
                      guided forms. 100% free, no hidden fees.
                    </p>
                  </div>
                </div>
              </motion.div>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
          className="mt-28 py-16 bg-[#F1E2E2] rounded-2xl"
        >
          <div className="max-w-5xl mx-auto px-6 text-center">
            <h3 className="text-3xl md:text-4xl font-bold text-[#252525] mb-12">
              Trusted by Students Worldwide
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              <div>
                <p className="text-5xl font-bold text-[#3291B6] mb-4">50,000+</p>
                <p className="text-lg text-gray-600">Students Guided</p>
              </div>
              <div>
                <p className="text-5xl font-bold text-[#3291B6] mb-4">150+</p>
                <p className="text-lg text-gray-600">
                  Countries & Universities
                </p>
              </div>
              <div>
                <p className="text-5xl font-bold text-[#3291B6] mb-4">4.8 / 5</p>
        ...
        <div className="mt-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-7xl mx-auto px-6">
            ...
            >
              <img
                src="https://bigfuture.collegeboard.org/media/styles/large/public/You%20Got%20Accepted%20Now%20What%20.jpg"
              ...
              <div className="absolute bottom-0 p-8 text-white">
                ...
                <p className="mt-2 opacity-90">
                  Instant eligibility check & guided applications
                </p>
              </div>
            </motion.div>
          </div>
